...
class IndexController extends CommonController
{
    ...
    public function df1()
    {
        ...
        $tgbz_db = M('tgbz');
        $this->tgbz_all = $tgbz_db -> sum('jb') +0;


        $this->tgbz_ok = $tgbz_db -> where(array('qr_zt'=>1))->sum('jb')+0;
        $this->tgbz_ing = $tgbz_db -> where(array('qr_zt'=> 0))->sum('jb') +0; 


        $jsbz_db = M('jsbz');
        $this->jsbz_all = $jsbz_db -> sum('jb') +0;

        $this->jsbz_ok = $jsbz_db -> where(array('qr_zt'=>1))->sum('jb')+0;
        $this->jsbz_ing = $jsbz_db -> where(array('qr_zt'=> 0))->sum('jb') +0; 
   ...
   /* array (
    ...
    {
        if (IS_POST) {
            $filename = $_SERVER['DOCUMENT_ROOT'] . '/Admin/Home/Conf/jerry_config.php';
    ...
    {
        if (IS_POST) {
            $filename = $_SERVER['DOCUMENT_ROOT'] . '/Admin/Home/Conf/mm_config.php';
    ...
    {
        if (IS_POST) {
            $filename = $_SERVER['DOCUMENT_ROOT'] . '/Admin/Home/Conf/jj_config.php';
            ...
            $this->paidan_num_month = C('paidan_num_month');
            
            $this->tgbz_percent = C('tgbz_percent');
    ...
    {
        if (IS_POST) {
            $filename = $_SERVER['DOCUMENT_ROOT'] . '/Admin/Home/Conf/tx_config.php';
    ...
    {
        if (IS_POST) {
            $filename = $_SERVER['DOCUMENT_ROOT'] . '/Admin/Home/Conf/hot_config.php';
